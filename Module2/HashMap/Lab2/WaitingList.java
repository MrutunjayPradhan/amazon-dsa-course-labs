...
public class WaitingList {
    ...
    public static void main(String[] args) {
        ...
        // Task 20: Change the studentLastName to "Rad".
        String studentLastName = "Rad";

        // Task 8: Change the value of option to 5 and run the application.
        // Task 14: Change the value of option to 6 and run the application.
        // Task 21: Change the value of option to 7 and run the application.
        // Task 27: Change the value of option to 8 and run the application.
        int option = 8;
