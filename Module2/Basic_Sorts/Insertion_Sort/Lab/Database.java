...
/**************************************************************************/
    // Task completed 1: Uncomment the method
    @SuppressWarnings("unchecked")
    public void insertionSort() {
        // Task completed 2: Set a local variable, regCount, equal to the
        //      size of the registrations array
        int regCount = registrations.size();
        // Task completed 3: Create a for-loop that starts with unsortedIndx = 1
        //      and ends at i < regCount
        for (int unsortedIndx =1; unsortedIndx<regCount;unsortedIndx++) {
            // Task completed 4: Initialize unsortedReg reference with the
            //      Registration at the unsortedIndx
            Registration unsortedReg = (Registration) registrations.get(unsortedIndx);
            // Task completed 5: Initialize sortedIndx with the unsortedIndx - 1
            int sortedIndx = unsortedIndx-1;
            // Task completed 6: Declare a while loop that ends when the sortedIndx >= 0
            while (sortedIndx>=0 ) {

                // Task completed 7: Initialize sortedReg with the Registration at the
                //      sortedIndx
                Registration sortedReg = (Registration) registrations.get(sortedIndx);
                 // Task completed 9: Comment out the print statement and the sorted_Index-- statements.
//                 System.out.println(unsortedIndx + " " + unsortedReg + ", " +
//                                    sortedIndx + " " + sortedReg.license);
//                 sortedIndx--;


                // Task completed 10: Declare an IF statement that uses the String
                ...
                if (sortedReg.license.compareTo(unsortedReg.license)>0) {
                    // Task completed 11: If the sortedReg license is greater than the
                    ...
                    // Task completed 12: If the sortedReg license is less than or equal
            ...
            // Task completed 13: After the while-loop but before returning to the
...
public void bubbleSort() {
    ...
    public static void main(String[] args) {
        ...
        /* Task completed 8: Replace the invocation of the bubbleSort() method
