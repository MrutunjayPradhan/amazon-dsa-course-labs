package Module2.Basic_Sorts.Bubble_Sort.Lab;
...
public class Database {
    ...
    // Task Complited 4: Uncomment the bubble sort method
   @SuppressWarnings("unchecked")
public void bubbleSort() {
        // Task Complited 5: Declare two local variables n and swapped
        int n= registrations.size();
        boolean swapped ;
        for (int i = 0; i < n - 1; i++) {
            // Task Complited 6: Set swapped to false
            swapped = false;
            for (int j = 0; j < n - 1 - i; j++) {
                // Task Complited 7: Get references to two Registration objects.
                ...
                // Task Complited 11: Remove the nextJ declaration and the print statement.
                //int nextJ = j + 1;
                //System.out.println(j + " " + currentReg.license + ", "
                //        + nextJ+ " " + nextReg.license);


                // Task Complited 12: Uncomment the IF statement.
                // Task Complited 13 Write an IF condition that is true if the license
                ...
                if ( currentReg.license.compareTo(nextReg.license)>0 ) {
                    // Task Complited 14: Swap the positions of the current and next
                    //          Registration objects in the array
                    Registration temp = (Registration) registrations.get(j);
                    registrations.set(j,nextReg);
                    registrations.set(j+1,temp);

                    // Task Complited 15: Set the swapped variable to true;
                    swapped=true;
                }
            }
            if (!swapped) {
    ...
    public static void main(String[] args) {
        ...
        // Task Complited 1: Create an instance of the Database class
        Database db = new Database();

        System.out.println("\n******* Unsorted List ******\n");

        // Task Complited 2: Call the printAll() method on the Database instance
        db.printAll();
        System.out.println("\n******* Sorted List ******\n");

        // Task Complited 8: Call the bubbleSort() method on the
        //          Database instance.
        db.bubbleSort();
        // Task Complited 9: call the printAll() method
        db.printAll();
